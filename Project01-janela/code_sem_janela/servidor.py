...
def listar_arquivos():
    return os.listdir('C:/Users/Lucas/OneDrive/Documentos/02 - 23.2/01 - REDES II/TP Final/Project01-janela/Arqs_Servidor')

# Função para enviar um arquivo para o cliente usando janela deslizante
def enviar_arquivo(nome_arquivo, endereco_cliente, porta_cliente):
    try:
        with open(os.path.join('C:/Users/Lucas/OneDrive/Documentos/02 - 23.2/01 - REDES II/TP Final/Project01-janela/Arqs_Servidor', nome_arquivo), 'rb') as arquivo:
            dados = arquivo.read()
            tamanho_janela = 3  # Tamanho da janela deslizante
            for i in range(0, len(dados), tamanho_janela):
                ...
                time.sleep(0.1)  # Simula o tempo de transmissão
...
def autenticar_cliente(conexao):
    senha_correta = "senha_secreta"  # Substitua pela senha desejada
...
def lidar_com_cliente(conexao, endereco_cliente):
    try:
        ...
        while True:
            ...
            # Envia o arquivo usando janela deslizante
...
# # Função para listar os arquivos no diretório do servidor
# def listar_arquivos():
#     return os.listdir('C:/Users/Lucas/OneDrive/Documentos/02 - 23.2/01 - REDES II/TP Final/Project 00/Arqs_Servidor')

# # Função para enviar um arquivo para o cliente usando UDP
# def enviar_arquivo(nome_arquivo, endereco_cliente, porta_cliente):
#     try:
#         with open(os.path.join('C:/Users/Lucas/OneDrive/Documentos/02 - 23.2/01 - REDES II/TP Final/Project 00/Arqs_Servidor', nome_arquivo), 'rb') as arquivo:
#             dados = arquivo.read()
#             cliente_udp_socket = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
